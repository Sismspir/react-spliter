...
function App() {
  ...
  return (
    <div className="bg-[#cee7f1] h-screen flex flex-col items-center justify-center space-y-5 font-serif">
      <div className='text-[1rem] tracking-[1rem] font-bold text-[#31642a] mb-8'>
        <h2>SPLI</h2>
        <h2>TTER</h2>
      </div>
      <div className='bg-[#ffffff] h-[40%] w-[50%] rounded-3xl flex flex-row items-center justify-center min-h-[20rem] min-w-[30rem]'>
        {/* First div*/}
        <div className='bg-[#ffffff] h-[85%] w-[45%] text-[#31642a]'>
          ...
          <form className='text-[#31642a] mt-8'>
              <h3 className='font-bold text-xs tracking-[0.08rem] mb-1'>Number of People</h3>
              <div className="relative inline-block w-full">
        ...
        {/* Second div*/}
        <div className='bg-[#174c4e] rounded-xl h-[85%] w-[45%] flex flex-col'>
          <div className='text-[#ffffff] self-center m-2'>
            <div className='flex flex-row space-x-[5vw] mt-[2vh]'>
              ...
              <div className='flex flex-row space-x-[0.5vw] text-[#7fffd4] text-[4vh] mt-2'>
          ...
          <div  className='text-[#ffffff] self-center m-2'>
            <div className='flex flex-row space-x-[5vw]'>
              ...
              <div className='flex flex-row space-x-[0.5vw] text-[#7fffd4] text-[4vh]'>
              $ {(isNaN(total) || people===0) ? <div> 0.00</div> : <p><div>{total.toFixed(2)}</div></p>}
              </div>
            </div>
          </div>
          <button onClick={() => {setBill(0); setPeople(0); setTip(0); setPercentage(0);}} className='mt-14 bg-[#328d91] h-[10%] w-[80%] rounded-sm justify-center self-center text-slate-600 hover:bg-[#7fffd4]'>RESET</button>
        </div>
      </div> 
    </div>
  );
